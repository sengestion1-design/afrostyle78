    ...
    <div class="container">
        <div style="display:flex;flex-wrap:wrap;justify-content:center;align-items:center;gap:32px;">
            <div style="display:flex;align-items:center;gap:10px;">
                ...
                <!-- MASTERCARD -->
                <svg width="46" height="30" viewBox="0 0 152 108" xmlns="http://www.w3.org/2000/svg"><rect width="152" height="108" rx="8" fill="#252525"/><circle cx="60" cy="54" r="30" fill="#eb001b"/><circle cx="92" cy="54" r="30" fill="#f79e1b"/><path d="M76 30a30 30 0 010 48 30 30 0 010-48z" fill="#ff5f00"/></svg>
            </div>
